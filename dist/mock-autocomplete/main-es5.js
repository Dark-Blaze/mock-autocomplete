...
/* harmony import */ var src_app_utils_search_filter_pipe__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! src/app/utils/search-filter.pipe */ "./src/app/utils/search-filter.pipe.ts");
...
var AutoCompleteComponent = /** @class */ (function () {
    function AutoCompleteComponent(dataService, searchFilter) {
     ...
     * @memberof AutoCompleteComponent
     */
    AutoCompleteComponent.prototype.keyup = function (e) {
        this.keyHandler(e);
     ...
     * @memberof AutoCompleteComponent
     */
    AutoCompleteComponent.prototype.keydown = function (e) {
    ...
    AutoCompleteComponent.prototype.setSelectedItem = function (item) {
        this.selectedItem = item;
    };
    AutoCompleteComponent.prototype.getCurrentPosition = function () {
        return this.currentPosition;
    };
    AutoCompleteComponent.prototype.setCurrentPosition = function (pos) {
        this.currentPosition = pos;
    };
    AutoCompleteComponent.prototype.setActiveItem = function (item) {
        this.activeItem = item;
    };
    AutoCompleteComponent.prototype.getActiveItem = function () {
     ...
     * @memberof AutoCompleteComponent
     */
    AutoCompleteComponent.prototype.keyHandler = function (e) {
    ...
    AutoCompleteComponent.prototype.setFilteredData = function (items) {
        this.filteredData = items;
    };
    AutoCompleteComponent.prototype.getFilteredData = function () {
     ...
     * @memberof AutoCompleteComponent
     */
    AutoCompleteComponent.prototype.setDataAndPosition = function () {
        var _this = this;
        this.setFilteredData(this.data.filter(function (i) { return _this.searchFilter.transform(_this.searchStr, i); }));
     ...
     * @memberof AutoCompleteComponent
     */
    AutoCompleteComponent.prototype.itemChange = function (data) {
        if (data.from !== 'mouse') {
     ...
     * @memberof AutoCompleteComponent
     */
    AutoCompleteComponent.prototype.resetBehaivour = function () {
     ...
     * @memberof AutoCompleteComponent
     */
    AutoCompleteComponent.prototype.onFocus = function (e) {
        this.setDataAndPosition();
     ...
     * @memberof AutoCompleteComponent
     */
    AutoCompleteComponent.prototype.hideSpan = function () {
        var _this = this;
        this.showSpan = false;
        setTimeout(function () { _this.searchElement.nativeElement.focus(); }, 0);
    };
    ...
    AutoCompleteComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        ...
        tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_data_service__WEBPACK_IMPORTED_MODULE_2__["DataService"], src_app_utils_search_filter_pipe__WEBPACK_IMPORTED_MODULE_3__["SearchFilterPipe"]])
...
var ScrollViewDirective = /** @class */ (function () {
    function ScrollViewDirective(el) {
        this.el = el;
        el.nativeElement.style.overflowY = 'scroll';
    }
    ScrollViewDirective.prototype.isLastViewableItem = function (cur) {
        if (cur === void 0) { cur = 0; }
        if (!cur || cur === 1) {
            return true;
        }
    ...
    ScrollViewDirective.prototype.ngOnChanges = function (changes) {
        var currentVal = changes.currentItem.currentValue;
        if (this.isLastViewableItem(currentVal)) {
            this.el.nativeElement.scrollTop = this.rowHeight * currentVal;
        }
    };
    ScrollViewDirective.prototype.ngAfterViewInit = function () {
...
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
/* harmony import */ var utils_search_filter_pipe__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! utils/search-filter.pipe */ "./src/app/utils/search-filter.pipe.ts");



var ListViewComponent = /** @class */ (function () {
    function ListViewComponent(searchFilter) {
        this.searchFilter = searchFilter;
        this.searchString = '';
    ...
    ListViewComponent.prototype.fireMouseOver = function (e, data, index) {
        this.selectedDataItem = data;
        this.itemChange.emit({ e: e, index: index, from: 'mouse', select: false });
    };
    ListViewComponent.prototype.selectItem = function (item, index) {
        this.itemChange.emit({ item: item, index: index, select: true, from: 'mouse' });
    };
    ListViewComponent.prototype.isItemFound = function (item) {
    ...
    ListViewComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        ...
        tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [utils_search_filter_pipe__WEBPACK_IMPORTED_MODULE_2__["SearchFilterPipe"]])
    ], ListViewComponent);
...
var HighlighterPipe = /** @class */ (function () {
    ...
    HighlighterPipe.prototype.transform = function (text, search) {
...
var SearchFilterPipe = /** @class */ (function () {
    ...
    SearchFilterPipe.prototype.transform = function (searchVal, args) {
